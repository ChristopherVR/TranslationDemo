...
/// </summary>
internal sealed class LocalizedEntityException : Exception
{
    ...
    internal LocalizedEntityException(string message, string? errorCode) : base(message) => Data.Add(ErrorCode, errorCode);
